...
function initAuthPage() {
    ...
    if (loginFormEl) {
        loginFormEl.addEventListener('submit', async function(e) {
            ...
            if (user) { showBanner('Successfully logged in. Welcome back, ' + (user.username || 'User') + '!', 'success'); setTimeout(function() { window.location.href = '../index.html'; }, 800); }
        });
    }
    ...
    if (registerFormEl) {
        registerFormEl.addEventListener('submit', async function(e) {
            ...
            if (user) { showBanner('Account created! Welcome, ' + (user.username || 'User') + '!', 'success'); setTimeout(function() { window.location.href = '../index.html'; }, 800); }
        });
    }
}
